...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const hasOnboarded = localStorage.getItem("eloquent-one_onboarded");
    if (!hasOnboarded) {
  ...
  const handleCompleteOnboarding = () => {
      localStorage.setItem("eloquent-one_onboarded", "true");
      if (onboardingNameInput.trim()) {
          localStorage.setItem("eloquent-one_name", onboardingNameInput.trim());
      ...
      {showOnboarding && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="glass-panel p-10 rounded-3xl w-full max-w-lg animate-fade-in shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">Welcome to Eloquent One</h2>
